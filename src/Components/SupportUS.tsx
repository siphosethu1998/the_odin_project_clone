const SupportUs = () => {
  ...
  <div className="bg-gray-100 flex flex-col items-center py-20 w-full">
      ...
      <p className='text-gray-500 py-6 sm:w-3/4 md:w-4/6 lg:w-1/4 text-sm'>The Odin Project is funded by the community. Join us in empowering learners around the globe by supporting The Odin Project!</p>
