    ...
    <div>
      <header className='flex flex-col justify-center'>
        ...
        <section className="flex flex-col text-center justify-center mx-4 mt-24 pb-4 px-8">
          ...
          <button className='py-3 px-6 border text-gray-700 border-slate-300 hover:bg-gray-50 rounded-md w-fit self-center'>View Full Curriculum</button>
        </section>
      ...
      <main className='flex flex-col'>
        ...
        <section className='flex flex-col bg-gray-100 px-20 py-8 text-center'>
          ...
          <button className='py-3 px-6 my-8 border text-gray-700 border-slate-300 rounded-md hover:bg-gray-50 self-center w-fit bg-white'>Explore curriculum</button>
        </section>
